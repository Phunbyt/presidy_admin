  ...
  return (
    <div className="p-8 space-y-6" style={{ background: t.bg, minHeight: '100%', transition: 'background 0.2s' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {/* Instructions card */}
        <div className="rounded-xl p-6" style={{ background: t.surface, border: `1px solid ${t.border}`, transition: 'background 0.2s' }}>
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: 'rgba(212,168,67,0.1)' }}>
            ...
            {[
              ...
              <li key={step.n} className="flex gap-4">
                ...
                <div className="pt-0.5">
                  <p className="text-sm font-medium" style={{ color: t.text }}>{step.title}</p>
        ...
        <div className="rounded-xl p-6" style={{ background: t.surface, border: `1px solid ${t.border}`, transition: 'background 0.2s' }}>
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center" style={{ background: 'rgba(82,196,160,0.1)' }}>
          ...
          <div
            className="rounded-lg p-4 mb-5 font-mono text-xs overflow-x-auto"
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={item.col} className="flex items-center gap-2.5">
                ...
                <span className="text-xs" style={{ color: t.textMuted }}>{item.desc}</span>
              </div>
            ))}
          </div>
        </div>
